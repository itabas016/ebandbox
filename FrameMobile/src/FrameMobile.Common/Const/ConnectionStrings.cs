...
namespace FrameMobile.Common
{
    ...
    {
        public const string COMMON_MYSQL_CONNECTSTRING = "Common_MySQL_ConnectString";
        ...
        public const string SECURITY_MYSQL_CONNECTSTRING = "Security_MySQL_ConnectString";
    }
}
