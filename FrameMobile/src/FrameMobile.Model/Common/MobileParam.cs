...
namespace FrameMobile.Model
{
    public class MobileParam
    {
        ...
        public const string KEY_FROM_APP_NO = "no";
        ...
        public const string Key_TargetAppno = "appno";
        public const string Key_PackageName = "pkgname";
        #endregion
        ...
        /// </summary>
        public virtual string AppNo { get { return this.GetValue(KEY_FROM_APP_NO); } }
        ...
        public virtual string TargetAppNo { get { return this.GetValue(Key_TargetAppno); } }

        public virtual string PackageName { get { return this.GetValue(Key_PackageName); } }
        ...
        public virtual string GetRealValue(string key)
        {
            if (!_hasAddedToDic)
            {
                _realValue[KEY_FROM_APP_NO] = this.AppNo;
                ...
                _realValue[Key_TargetAppno] = this.TargetAppNo;
                _realValue[Key_PackageName] = this.PackageName;
